...
class ScaleAndFilter(object):
  ...
  def __init__(self, params, scaling_params, filtering_params, scaling_script,
    filtering_script):
  ...
  def scale_and_filter(self, experiments, reflections):
    ...
    for counter in range(1, self.params.filtering.max_cycles+1):
      ...
      scaling_script = self.scaling_script(self.scaling_params, experiments, reflections)
      ...
      filter_script = self.filtering_script(self.filtering_params, scaling_script.experiments,
      ...
      if latest_results['cumul_percent_removed'] > self.params.filtering.max_percent_removed:
      ...
      if self.params.filtering.min_completeness:
        if latest_results['merging_stats']['completeness'] < self.params.filtering.min_completeness:
