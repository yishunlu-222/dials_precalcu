...
def test_scale_merging_stats():
  ...
  merging_statistics_result = Script.merging_stats_from_scaled_array(scaled_array, params)
...
def test_scale_script_prepare_input():
  ...
  params, script_exp, script_reflections = Script.prepare_input(params, exp, reflections)
